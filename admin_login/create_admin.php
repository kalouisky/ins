...
<?php
    ...
    if (isset($_REQUEST['username'])){
		...
		$full_names = mysqli_real_escape_string($con,$full_names);
    ...
    $date = NOW();
        $query = "INSERT into `user` (full_names, phone_number, username, email, password, trn_date, created_by, role) VALUES ('$full_names', '$phone_number', '$username', '$email', '$password',  '$trn_date', '$created_by', '$role')";
